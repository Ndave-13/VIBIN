# **VIBIN - Emotion-Based Music Recommendation App**
...
Realizing this need, **VIBIN** is being developed by [Son Nguyen](https://github.com/hoangsonww) in 2024 to provide personalized music recommendations based on users' detected emotions.

The **VIBIN** project is an integrated emotion-based music recommendation system that combines frontend, backend, AI/ML models, and data analytics to provide personalized music recommendations based on user emotions. The application analyzes text, speech, or facial expressions and suggests music that aligns with the detected emotions.

Supporting both desktop and mobile platforms, **VIBIN** offers a seamless user experience with real-time emotion detection and music recommendations. The project leverages **React for the frontend, Django for the backend, and three advanced, self-trained AI/ML models for emotion detection**. Data analytics scripts are used to visualize emotion trends and model performance. Users will be directed to Spotify to listen to the recommended music, and they can save their favorite tracks to their Spotify account.

<p align="center">
  <img src="images/VIBIN-logo.png" alt="VIBIN Logo" width="50%" style="border-radius: 12px">
</p>
...
VIBIN provides personalized music recommendations based on users' emotional states detected through text, speech, and facial expressions. It interacts with a Django-based backend, AI/ML models for emotion detection, and utilizes data analytics for visual insights into emotion trends and model performance.

<h2 id="-live-frontend-demo">🌐 Live Deployment</h2>

The VIBIN app is currently live and deployed on Vercel. You can access the live app using the following link: [VIBIN](https://VIBIN-app.vercel.app).

Feel free to also visit the backend at [VIBIN Backend API](https://VIBIN-emotion-music-app.onrender.com/).
...
> **Disclaimer:** The backend of VIBIN is currently hosted with the **Free Tier** of Render, so it may take a few seconds to load initially. Additionally, it may spin down after a period of inactivity or high traffic, so please be patient if the backend takes a few seconds to respond.
...
[![Deployed with Vercel](https://img.shields.io/badge/Deployed%20with-Vercel-green?logo=vercel)](https://VIBIN-emotion-music-app.vercel.app/)
[![Deployed with Render](https://img.shields.io/badge/Deployed%20with-Render-green?logo=render)](https://VIBIN-emotion-music-app.onrender.com/)
[![AI/ML Tests Passing](https://img.shields.io/badge/AI/ML%20Tests-Passing-brightgreen?logo=ai)](ai_ml)
[![Netlify Backup OK](https://img.shields.io/badge/Netlify%20Backup-OK-brightgreen?logo=netlify)](https://VIBIN-emotion-music-app.netlify.app/)
...
The VIBIN project aims to provide the following features:
...
Here is the list of technologies used in the VIBIN project:
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/hoangsonww/VIBIN-Emotion-Music-App.git
   ```

2. **Navigate to the AI/ML directory:**
   ```bash
   cd VIBIN-Emotion-Music-App/ai_ml
   ```
...
- **Swagger UI**: `https://VIBIN-emotion-music-app.onrender.com/swagger`.
- **Redoc**: `https://VIBIN-emotion-music-app.onrender.com/redoc`.
...
There is also a mobile version of the VIBIN app built using React Native and Expo. You can find the mobile app in the `mobile` directory.
...
3. **Expose the services:**
    ```bash
    kubectl expose deployment VIBIN-backend --type=LoadBalancer --port=8000
    kubectl expose deployment VIBIN-frontend --type=LoadBalancer --port=3000
    ```
...
We have also included Jenkins pipeline script for automating the build and deployment process. You can use Jenkins to automate the CI/CD process for the VIBIN app.
...
3. **Run the Jenkins pipeline:**
    - Run the Jenkins pipeline to build and deploy the VIBIN app.
...
- If you have any suggestions, feature requests, or bug reports, feel free to open an issue [here](https://github.com/hoangsonww/VIBIN-Emotion-Music-App/issues).
...
[🔝 Back to Top](#VIBIN---emotion-based-music-recommendation-app)
